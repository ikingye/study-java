...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-java/flexsearch.min.js');loadScript('/study-java/en.search-data.min.bccce78caf98f855ee16fe1ac9e2590e88e6aeb06ddeffecf07df5ea6fd56dc4.js',function(){input.required=false;search();});}
