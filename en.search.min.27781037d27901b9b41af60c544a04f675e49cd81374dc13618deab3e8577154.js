...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-java/flexsearch.min.js');loadScript('/study-java/en.search-data.min.c44f45f84a4df3e442ecafd940f4fd5058172f918955fb407879a4e1e608959f.js',function(){input.required=false;search();});}
