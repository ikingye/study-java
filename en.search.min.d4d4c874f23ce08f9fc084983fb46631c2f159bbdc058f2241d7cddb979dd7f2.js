...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-java/flexsearch.min.js');loadScript('/study-java/en.search-data.min.ea4fc15c90d0a1bf0865e08da2a23745b26eaf2030b14a7000585ebacd709b13.js',function(){input.required=false;search();});}
