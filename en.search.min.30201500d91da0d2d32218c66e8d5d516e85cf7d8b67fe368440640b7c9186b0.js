...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-java/flexsearch.min.js');loadScript('/study-java/en.search-data.min.e4119b18a5d101e59be516bc4bedcbb4d455ff04e2be183b60bf85d74edc9e37.js',function(){input.required=false;search();});}
