...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-java/flexsearch.min.js');loadScript('/study-java/en.search-data.min.76b54b7b0b62ebb489357dd0d9bb77077087b1fd71d6add2ef0fb05acd5d2003.js',function(){input.required=false;search();});}
