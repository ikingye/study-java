...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-java/flexsearch.min.js');loadScript('/study-java/en.search-data.min.8a6f39b5eaa1a1d12aa3952dadf814fd387b147204fc1308d696b05c881fde64.js',function(){input.required=false;search();});}
