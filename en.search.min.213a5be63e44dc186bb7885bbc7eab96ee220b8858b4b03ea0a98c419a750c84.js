...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-java/flexsearch.min.js');loadScript('/study-java/en.search-data.min.93dd27ed7d8a542a7df5e4e1b23e3912d5eb69ac002fbab5e24fc443bfb36abe.js',function(){input.required=false;search();});}
